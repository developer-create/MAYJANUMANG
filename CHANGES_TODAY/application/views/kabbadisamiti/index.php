<div class="content-wrapper">
    <section class="content-header"> 
            <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Khel Samiti Locations
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">खेल समिति स्थान (Khel Samiti Locations) List</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body">
                        <form method="get" action="<?php echo site_url('kabbadisamiti'); ?>" class="form-inline" id="filterForm">
                            ...
                            <div class="form-group" style="margin-left: 15px;">
                                ...
                                <select name="filter_samiti_type" id="filter_samiti_type" class="form-control input-sm">
                                    <option value="">All</option>
                                    <?php if (!empty($samiti_types)): foreach ($samiti_types as $st): ?>
                                    <option value="<?php echo $st['id']; ?>" <?php echo (isset($filter_samiti_type) && $filter_samiti_type == $st['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($st['name']); ?></option>
                        ...
                        <table class="table table-bordered table-striped" id="kabbadiSamitiTable">
                            <thead>
                                <tr style="color:white;font-size:15px;background-color:#020254;">
                                    <th>Sr No</th>
                                    <th>Unique ID</th>
                                    <th>समिति प्रकार (Samiti Type)</th>
                                    <th>वर्ष (Year)</th>
                                    <th>AC/MP No.</th>
                                    <th>ब्लॉक (Block)</th>
                                    <th>सेक्टर (Sector)</th>
                            ...
                            <tbody>
                                <?php if(!empty($records)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo isset($group['samiti_type_name']) ? $group['samiti_type_name'] : '-'; ?></td>
        ...
        "buttons": [
            {
                ...
                title: 'Khel Samiti Locations List',
                exportOptions: {
