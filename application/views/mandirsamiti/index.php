<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Mandir Samiti Locations
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">मंदिर समिति स्थान (Mandir Samiti Locations) List</h3>
                        <div style="float: right;">
                            <a href="<?php echo site_url('mandirsamiti/create'); ?>" class="btn btn-success">Add New Location</a>
                        </div>
                    </div><!-- /.box-header -->
                    <!-- Total Members Card -->
                    ...
                    <!-- Filters -->
                    <div class="box-body">
                        <form method="get" action="<?php echo site_url('mandirsamiti'); ?>" class="form-inline" id="filterForm">
                            ...
                            <div class="form-group" style="margin-left: 15px;">
                                ...
                                <a href="<?php echo site_url('mandirsamiti'); ?>" class="btn btn-default btn-sm">Reset</a>
                            </div>
                        </form>
                    </div>
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover" id="mandirsamitiTable">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $group['unique_id']; ?></td>
                                    ...
                                    <td><span class="badge bg-blue"><?php echo isset($group['total_members']) ? $group['total_members'] : 0; ?></span></td>
                                    <td>
                                        <a href="<?php echo site_url('mandirsamiti/members/'.$group['id']); ?>" class="btn btn-primary btn-xs" title="View Members">
                                            <i class="fa fa-users"></i> View
                                        </a>
                                        <a href="<?php echo site_url('mandirsamiti/edit/'.$group['id']); ?>" class="btn btn-warning btn-xs" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?php echo site_url('mandirsamiti/delete/'.$group['id']); ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this location and all its members?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Mandir Samiti Locations List',
                exportOptions: {
