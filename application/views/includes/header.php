                 ...
                 <li> 
                  ...
                  foreach ($modulesToProcess as $module) {
                    ...
                    $isSamitiModule = (strcasecmp($moduleName, 'DP-Samiti') == 0 ||
                                      strcasecmp($moduleName, 'Ganesh-Samiti') == 0 ||
                                       strcasecmp($moduleName, 'Khel-Samiti') == 0 ||
                  ...
                  foreach ($otherModules as $module) {
                    ...
                    if (strcasecmp($moduleName, 'Dashboard') == 0) {
                        ...
                        $icon = 'fa-exchange';
                    } elseif (strcasecmp($moduleName, 'MemberList') == 0) {
                        $icon = 'fa-id-card';
                    } elseif (strcasecmp($moduleName, 'Vidhansabha-Member') == 0) {
                        $icon = 'fa-user';
                    } elseif (strcasecmp($moduleName, 'MP-Vidhansabha-Member') == 0) {
                        $icon = 'fa-user';
                    }
                    ...
                    if (strcasecmp($moduleName, 'Events') == 0) {
                        ...
                        if ($this->session->userdata('role') == 1) {
                            ...
                            $pendingCount = $this->Events_model->get_pending_count();
                        }
                        ?>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa <?php echo $icon; ?>"></i> <span>Events</span>
                    ...
                    // Insert Member List dropdown right after MP-publicproblem (if it exists) and Assembly Issue
