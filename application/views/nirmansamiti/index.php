<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Nirman Samiti Locations
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">निर्माण समिति स्थान (Nirman Samiti Locations) List</h3>
                        <div style="float: right;">
                            <a href="<?php echo site_url('nirmansamiti/create'); ?>" class="btn btn-success">Add New Location</a>
                        </div>
                    </div><!-- /.box-header -->
                    <!-- Total Members Card -->
                    ...
                    <!-- Filters -->
                    <div class="box-body">
                        <form method="get" action="<?php echo site_url('nirmansamiti'); ?>" class="form-inline" id="filterForm">
                            ...
                            <div class="form-group" style="margin-left: 15px;">
                                ...
                                <a href="<?php echo site_url('nirmansamiti'); ?>" class="btn btn-default btn-sm">Reset</a>
                            </div>
                        </form>
                    </div>
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover" id="nirmansamitiTable">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('nirmansamiti/members/'.$group['id']); ?>" class="btn btn-primary btn-xs" title="View Members">
                                            <i class="fa fa-users"></i> View
                                        </a>
                                        <a href="<?php echo site_url('nirmansamiti/edit/'.$group['id']); ?>" class="btn btn-warning btn-xs" title="Edit">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?php echo site_url('nirmansamiti/delete/'.$group['id']); ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this location and all its members?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Nirman Samiti Locations List',
                exportOptions: {
