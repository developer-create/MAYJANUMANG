        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php 
                    // For edit mode, we use jansunwai object
                    $form_data = [];
                    ?>
                    ...
                    <form role="form" id="editJansunwai" action="<?php echo base_url() ?>user/updateJansunwai"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="office" name="office">
                                            ...
                                            <option value="Bhopal" <?php echo set_select('office', 'Bhopal', $jansunwai->office === 'Bhopal'); ?>>Bhopal</option>
                                            <option value="Dhar" <?php echo set_select('office', 'Dhar', $jansunwai->office === 'Dhar'); ?>>Dhar</option>
                                            <option value="Bagh" <?php echo set_select('office', 'Bagh', $jansunwai->office === 'Bagh'); ?>>Bagh</option>
                                            <option value="Gandhwani" <?php echo set_select('office', 'Gandhwani', $jansunwai->office === 'Gandhwani'); ?>>Gandhwani</option>
                                            <option value="Tanda" <?php echo set_select('office', 'Tanda', $jansunwai->office === 'Tanda'); ?>>Tanda</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control required" id="date" name="date"
                                            value="<?php echo set_value('date', $jansunwai->date); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="sector_name"
                                            name="sector_name" value="<?php echo set_value('sector_name', $jansunwai->sector_name); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="micro_sector_no"
                                            name="micro_sector_no" value="<?php echo set_value('micro_sector_no', $jansunwai->micro_sector_no); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="micro_sector_name"
                                            ...
                                            value="<?php echo set_value('micro_sector_name', $jansunwai->micro_sector_name); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 required" id="district" name="district">
                                            ...
                                            <option value="<?php echo $district->id ?>" <?php echo set_select('district', $district->id, $jansunwai->district == $district->id); ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 required" id="assembly" name="assembly">
                                            ...
                                            <option value="<?php echo $assembly->id ?>" <?php echo set_select('assembly', $assembly->id, $jansunwai->assembly == $assembly->id); ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="majra_faliya"
                                            name="majra_faliya" value="<?php echo set_value('majra_faliya', $jansunwai->majra_faliya); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="work_problem"
                                            name="work_problem" value="<?php echo set_value('work_problem', $jansunwai->work_problem); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="priority" name="priority"
                                            value="<?php echo set_value('priority', $jansunwai->priority); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="approximate_cost"
                                            ...
                                            value="<?php echo set_value('approximate_cost', $jansunwai->approximate_cost); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="recommended_letter_no"
                                            ...
                                            value="<?php echo set_value('recommended_letter_no', $jansunwai->recommended_letter_no); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ts_no_date" name="ts_no_date"
                                            value="<?php echo set_value('ts_no_date', $jansunwai->ts_no_date); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="as_no_date" name="as_no_date"
                                            value="<?php echo set_value('as_no_date', $jansunwai->as_no_date); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="middle_men"
                                            name="middle_men" value="<?php echo set_value('middle_men', $jansunwai->middle_men); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cont_no" name="cont_no" 
                                            ...
                                            value="<?php echo set_value('cont_no', $jansunwai->cont_no); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="beneficial"
                                            name="beneficial" value="<?php echo set_value('beneficial', $jansunwai->beneficial); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="po" name="po"
                                            value="<?php echo set_value('po', $jansunwai->po); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile" 
                                            maxlength="10" pattern="[0-9]{10}" placeholder="10 digits only"
                                            value="<?php echo set_value('mobile', $jansunwai->mobile); ?>">
                                        <small class="text-muted">Must be exactly 10 digits</small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="account_details"
                                            name="account_details"><?php echo set_value('account_details', $jansunwai->account_details); ?></textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="id_proof_number"
                                            name="id_proof_number" value="<?php echo set_value('id_proof_number', $jansunwai->id_proof_number); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="remark_goshana"
                                            name="remark_goshana"><?php echo set_value('remark_goshana', $jansunwai->remark_goshana); ?></textarea>
...
$(document).ready(function() {
    ...
    $('#editJansunwai').on('submit', function(e) {
        ...
        var formDataToSave = {};
        $('#editJansunwai').find('input, select, textarea').each(function() {
            var $field = $(this);
