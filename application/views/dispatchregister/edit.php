                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="type" name="type" required>
                                            ...
                                            <option value="1" <?php echo (isset($dispatch_register->type) && $dispatch_register->type == '1') ? 'selected' : ''; ?>>Dispatch (Outward)</option>
                                            <option value="2" <?php echo (isset($dispatch_register->type) && $dispatch_register->type == '2') ? 'selected' : ''; ?>>Inward</option>
                                            <option value="3" <?php echo (isset($dispatch_register->type) && $dispatch_register->type == '3') ? 'selected' : ''; ?>>Miscellaneous</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="district_id" name="district_id">
                                            ...
                                            <?php foreach($districts as $district): 
                                                $selected = ($district->id == $dispatch_register->district_id) ? 'selected' : '';
                                            ?>
                                                <option value="<?php echo $district->id; ?>" <?php echo $selected; ?>><?php echo $district->name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
