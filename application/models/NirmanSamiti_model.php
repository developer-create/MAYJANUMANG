<?php
class NirmanSamiti_model extends CI_Model {
    ...
    public function get_group_by_id($id) {
        ...
        $this->db->select('nirman_samiti_groups.*, block.name as block_name, 
                          nirman_samiti_groups.booth_name as booth_id,
                          booth.name as booth_display_name, booth.bnumber as booth_no');
        $this->db->from('nirman_samiti_groups');
        $this->db->join('block', 'block.id = nirman_samiti_groups.block', 'left');
        $this->db->join('booth', 'booth.id = nirman_samiti_groups.booth_name', 'left');
        $this->db->where('nirman_samiti_groups.id', $id);
        $query = $this->db->get();
    ...
    public function create_group($data) {
        ...
        $this->db->insert('nirman_samiti_groups', $data);
    ...
    public function update_group($id, $data) {
        ...
        $this->db->where('id', $id);
        return $this->db->update('nirman_samiti_groups', $data);
    }
    ...
    public function delete_group($id) {
        ...
        $this->db->delete('nirman_samiti');
        
        // Delete group
        $this->db->where('id', $id);
        return $this->db->delete('nirman_samiti_groups');
    }
    ...
    public function get_member_by_id($id) {
        $query = $this->db->get_where('nirman_samiti', array('id' => $id));
        return $query->row_array();
    }
    ...
    public function create_member($data) {
        $data['created_at'] = date('Y-m-d H:i:s');
        $this->db->insert('nirman_samiti', $data);
        return $this->db->insert_id();
    }
    ...
    public function update_member($id, $data) {
        $data['updated_at'] = date('Y-m-d H:i:s');
        $this->db->where('id', $id);
        return $this->db->update('nirman_samiti', $data);
    }

    // Delete member
    public function delete_member($id) {
        $this->db->where('id', $id);
        return $this->db->delete('nirman_samiti');
    }
